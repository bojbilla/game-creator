    ...
    "save post to database." in {
      testWithDb {
        db =>
          ...
          val collection = db[BSONCollection](MongoCollections.fbPosts)
    ...
    "save page to database." in {
      testWithDb {
        db =>
          ...
          val collectionPages = db[BSONCollection](MongoCollections.fbPages)
          ...
          val collectionPageLikes = db[BSONCollection](MongoCollections.fbPageLikes)
