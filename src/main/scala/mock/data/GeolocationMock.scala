...
import entities.Entities.{Geolocation, Location, Question}
...
class GeolocationMock {
  ...
  val geolocation1 = Geolocation("1234789247", user_id, question1, location1)

  private val question2 = Question("Where were you when you wrote that post?", Some("Still working here"),
    Some("http://isic3.epfl.ch/scs-fallmeeting/images/EPFL_panorama1.jpg"))
  private val location2 = Location(46.522052, 6.566304)
  val geolocation2 = Geolocation("487982734", user_id, question2, location2)
  ...
  val geolocation3 = Geolocation("986786223", user_id, question3, location3)
