...
import entities.Entities.{GeolocationQuestion, Location, Question}
...
class GeolocationMock {
  ...
  val geolocation1 = GeolocationQuestion("1234789247", user_id, question1, location1)
  ...
  val geolocation2 = GeolocationQuestion("487982734", user_id, question2, location2)
  ...
  val geolocation3 = GeolocationQuestion("986786223", user_id, question3, location3)
